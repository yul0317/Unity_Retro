...
public class Move : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKey(KeyCode.UpArrow))
        {
            ...
            //transform.position = transform.position + transform.up * Time.deltaTime * 1;
            //Debug.Log("1" + transform.position + transform.up * Time.deltaTime);
            //Debug.Log("2" + transform.position + transform.up * Time.deltaTime * 1);
